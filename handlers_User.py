...
def conectar_ao_banco():
    try:
        ...
        print(f"Erro na função conectar_ao_banco: {err}")
        return None
...
# Função para manipular o menu principal
def handleMenu(bot, message):
    try:
        ...
        try:
            ...
            print(f"Erro na função handleMenu durante execução de MySQL: {e}")
        ...
        print(f"Erro na função handleMenu: {e}")
